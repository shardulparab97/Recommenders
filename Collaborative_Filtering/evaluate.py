...
print ("PRECISION ON TOP K:",findPrecisiononTopK(rankings,testData))

print ("SPEARMANS CORRELATION COEFFICIENT:",spearman_rank_correlation(rankings,testData))
