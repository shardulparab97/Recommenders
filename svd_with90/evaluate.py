...
with open('./X_pred_new.p', 'rb') as f:
    A_new = pickle.load(f)
...
print ("RMSE Score =",rmse(A_new,testData))
print ("Precision on top k score = ",top_k_precision(A_new,testData))
print ("Spearman's score=",(spearman_rank_correlation(A_new,testData)))
