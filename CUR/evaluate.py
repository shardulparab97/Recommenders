...
#print A_pred
print ("RMSE SCORE = ",rmse(A_pred,testData))
print ("PRECISION ON TOP K SCORE =",top_k_precision(A_pred,testData))
print ("SPEARMANS SCORE=",spearman_rank_correlation(A_pred,testData))
